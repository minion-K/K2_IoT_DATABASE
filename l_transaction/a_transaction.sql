...
# Consistency(일관성): 트랜잭션 전, 후 데이터베이스의 일관성이 유지
...
# 		- 각 INSERT, UPDATE, DELETE 쿼리 실행 직후 자동 COMMIT
#		- 실패가 없으면 자동 저장
