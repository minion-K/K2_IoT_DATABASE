...
select 
    ...
    B.brand_id, B.brand_name, P.product_name, P.price
...
where ranked_products.number <= 3
order by ranked_products.brand_id, ranked_products.number
